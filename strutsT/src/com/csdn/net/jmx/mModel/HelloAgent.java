package com.csdn.net.jmx.mModel;

import javax.management.MBeanServer;
import javax.management.MBeanServerFactory;
import javax.management.ObjectName;

import com.csdn.net.jmx.mModel.Hello;
...
public class HelloAgent {
	public static void main(String[] args) throws Exception {
		...
		ObjectName helloName = new ObjectName("changeang:name=HelloWorld");
	 ...
	 * chengang:name=HelloWorld的名字是有一定规则的，格式为：“域名:name=MBean名称”，
	 * 域名和MBean名称都可以任意取。
	 * 
	 ...
	 * 五、总结
	 * 
	 * 在实际系统中我们可以把name变成决定数库链接池的变量，这样我就可以对系统的运行参数进行实现的监控和配置（管理）。而且也可以对一些方法（
	 * 如printHello）进行远程调用了。
	 */
}
